...
function toggleArbiter(linkObj)
{
    let menu = document.getElementsByClassName("arbiter-specific");
...
var filterList = {
    ...
    "Python" : ["arbiter-stuff", "python-pdf", "pydatabase", "py-projs", "py-calc"],
    "MySQL" : ["arbiter-stuff", "c-files", "pydatabase"],

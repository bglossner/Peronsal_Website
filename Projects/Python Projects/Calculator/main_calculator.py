...
def doAddSub(numStr):
    ...
    if count == 0:
        ...
        plusFind = numStr.find("+")
        minusFind = numStr.find("-")
        if((plusFind < minusFind and plusFind != -1) or (plusFind != -1 and minusFind == 0) or minusFind == -1):
            char = "+"
            l1 = findNumsLR(numStr, "+")
            str_to_replace += l1[0] + "+" + l1[1]
            ...
            if strHold.count("-") == 0 and strHold.count("+") == 0:
                return numStr
            char = "-"
            l1 = findNumsLR(numStr, "-")
            str_to_replace += l1[0] + "-" + l1[1]
